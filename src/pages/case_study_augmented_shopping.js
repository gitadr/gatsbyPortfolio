        ...
        <article>
          ...
          <section>
            ...
            <p>
              ...
              and define the problem further. Part of that process was a
              heuristic review. The review highlighted key pain points but also
          ...
          <section>
            ...
            <p>
              ...
              consecutively. This behaviour was also overlooked. After each scan
              a user had to return to the search page and navigate to the
              scanner again.
            </p>
            <h4>Match between system and the real world</h4>
            <p>
              When a user launched the scanner for the first time the OS
              requires a user's permission to access the camera. In the existing
            ...
            <p>
              ...
              presented with the results for that exact product. Due to the
              design of the product pages, if that product wasn't in stock, no
            ...
            <p>
              ...
              still using older styles. The navigation header was now
              inconsistent and the close button was in the wrong place.
            </p>
            ...
            <p>
              ...
              value in framing the barcode better? Could more be done to shape
              the view to the scale and size of a barcode?
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              ...
              I'd started with a fairly narrow scope but after further
              exploration had found a number of other opportunities that could
              be worth investigating. I presented my findings to the app team
              for feedback and with their help, validated, defined and
          ...
          <section>
            <h3>Concepts</h3>
            <p>
              Because the heuristic review highlighted a number of
              opportunities, I wanted to visualise some potential solutions in
              order for the team to evaluate and estimate the technical work
              involved before we defined the MVP.
            </p>
          </section>
          <StaticImage
          ...
          <section>
            <h2>Opportunity</h2>
            <p>
              Woolworths processes billions of transactions every week but only
              a percentage are from online sales. As a mobile team we were
              always looking for ways to improve the experience of app users
              shopping in-store.
            </p>
            ...
            <p>
              ...
              groceries app of the future? After a number of workshops we
              narrowed our focus to 4 areas.
            </p>
            <h3>Key concepts</h3>
            <ol>
          ...
          <section className={styles.mobileDesign}>
            <div className={styles.workText}>
              ...
              <p>
                ...
                allocated development resource, so instead I scoured the
                internet looking for prototypes that could achieve our goal.
              </p>
              <p>
          ...
          <section>
            ...
            <p>
              ...
              The designs below were an early explorations in achieving the
              goals listed above. The final concepts where later presented to
