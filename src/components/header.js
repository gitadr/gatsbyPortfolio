  ...
  <header>
    <div class="container">
      ...
      <div className={styles.headerBody}>
        <p>
        Over the past eleven years I have focused on designing things that help people understand and act on complex information. Whether that's geospatial projections or trading data, the goal has been to create products that are simple, innovative and empowering.
        </p>
        <p>
